...
- Provide resources to the users to be able to identify misinformation more easily, such as tools within the social media app or short training courses/videos. This would allow users to identify and avoid misinformation within posts more easily. For example, this would help Interviewee 2 to achieve a higher level of inoculation against misinformation that Interviewee 1 already has due to irony/post-irony/meta-irony exposure.